...
from app.ocr_utils import processImage, extractTextFromImage, encodePrdeictions
...
async def getTextFromImage(id: str, background_tasks: BackgroundTasks):
    file_name = f"{id}.jpg"  # Assuming only JPEG files are handled
    file_path = os.path.join(IMAGEDIR, file_name)
    ...
    try:
        ...
        return {"extracted_text": "successfully extracted text"}
...
def cleanup_file(file_path: str):
    try:
        ...
        # Optionally, you can log this error if you have a logging mechanism
        pass
